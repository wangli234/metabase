...
(defmethod driver/details-fields :mysql [_]
...
(defmethod driver/current-db-time :mysql [driver db]
  (driver.common/current-db-time mysql-db-time-query mysql-date-formatters driver db))
...
(defmethod sql-jdbc.sync/active-tables :mysql [driver metadata]
