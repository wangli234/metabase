...
(defmethod driver/can-connect? :oracle [_ details]
...
(defmethod driver/details-fields :oracle [_]
...
(defmethod driver/execute-query :oracle [driver query]
  (remove-rownum-column (driver/execute-query :sql-jdbc driver query)))
...
(defmethod driver/current-db-time :oracle [driver db]
  (driver.common/current-db-time oracle-db-time-query oracle-date-formatters driver db))
