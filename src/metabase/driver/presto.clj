...
(defmethod driver/can-connect? :presto [_ {:keys [catalog] :as details}]
...
(defmethod driver/humanize-connection-error-message :presto [message]
...
(defmethod driver/current-db-time :presto [driver database]
  (driver.common/current-db-time presto-db-time-query presto-date-formatters driver database))
...
(defmethod driver/details-fields :presto [_]
