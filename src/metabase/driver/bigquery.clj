...
(defmethod driver/details-fields :bigquery [_]
  [{:name         "project-id"
...
(defmethod driver/current-db-time :bigquery [driver database]
  (driver.common/current-db-time bigquery-db-time-query bigquery-date-formatters driver database))
