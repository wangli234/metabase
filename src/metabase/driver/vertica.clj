...
(defmethod driver/current-db-time :vertica [driver db]
  (driver.common/current-db-time vertica-db-time-query vertica-date-formatters driver db))

(defmethod driver/details-fields :vertica [_]
