...
(defmulti apply-top-level-clause
  "Implementations of this methods define how the SQL Query Processor handles given query clauses. Each method is called
  when a matching clause is present in `query`, and should return an appropriately modified version of
...
(defn- apply-top-level-clauses
  ...
  (loop [honeysql-form honeysql-form, [k & more] (keys inner-query)]
