...
(defmethod driver/available? :sparksql [_]
  (register-driver/register-hive-jdbc-driver-if-needed!)
  (register-driver/hive-jdbc-driver-available?))
...
(defmethod driver/details-fields :sparksql [_]
